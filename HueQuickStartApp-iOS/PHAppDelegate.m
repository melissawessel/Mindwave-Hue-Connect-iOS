...
@property (nonatomic, strong) HelloConnectViewController * mindwaveViewController;
...
#pragma mark - connect to mindwave device

- (void)startBrainStuff {
    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:self.mindwaveViewController];
    navController.modalPresentationStyle = UIModalPresentationFormSheet;
    [self.navigationController presentViewController:navController animated:YES completion:nil];
}
